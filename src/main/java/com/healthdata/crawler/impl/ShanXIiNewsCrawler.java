...
public class ShanXIiNewsCrawler implements NewsCrawler {

    private final String pageUrl ="https://wjw.shanxi.gov.cn/xwzx/szyw/";
    ...
    public List<NewsItem> fetchNewsByDate(LocalDate date) {
        ...
        try{
            Document doc = Jsoup.connect(pageUrl)
                    ...
                    .timeout(10000)
                    .get();
            Elements blocks = doc.select("div.demo-right >ul>li"); //直接选择ul下所有 li（推荐）
            ...
            System.err.println("❌ 山西省爬虫失败：" + e.getMessage());
        }
        return result;
    }
    @Override
