...
public class GuangXiNewsCrawler implements NewsCrawler {

    private final String pageUrl ="https://wsjkw.gxzf.gov.cn/xwdt_49370/";
    ...
    public List<NewsItem> fetchNewsByDate(LocalDate date) {
        ...
        try{
            Document doc = Jsoup.connect(pageUrl)
                    ...
                    .timeout(10000)
                    .get();
            Elements blocks = doc.select("ul.txt-list.fs16 >li"); //直接选择ul下所有 li（推荐）
            ...
            System.err.println("❌ 广西省爬虫失败：" + e.getMessage());
        }
        return result;
    }
    @Override
