...
public class ZheJiangNewsCrawler implements NewsCrawler {
    private final String pageUrl ="https://wsjkw.zj.gov.cn/col/col1229055217/index.html";
    ...
    public List<NewsItem> fetchNewsByDate(LocalDate date) {
        ...
        try{
            Document doc = Jsoup.connect(pageUrl)
                    ...
                    .timeout(10000)
                    .get();
            Elements blocks = doc.select("div.lm_r.right > ul > li"); //直接选择ul下所有 li（推荐）
            ...
            System.err.println("❌ 浙江省爬虫失败：" + e.getMessage());
        }
        return result;
    }
    @Override
